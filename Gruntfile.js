...
module.exports = function (grunt) {
    ...
    // Load assemble before all other tasks
    ...
    grunt.initConfig({
        ...
        // Assemble our Layouts, Pages and Partials together
        assemble: {
            options: {
                flatten: true,
                layout: 'layout.hbs',
                ...
                helpers: ['handlebars-helper-repeat', 'handlebars-helper-lorem'],
                data: '<%= config.app %>/templates/ipsum.json'
            },
            dist: {
                files: {
            ...
            dist: {
                files: {
                    '<%= config.dist %>/scripts/main.js': [
                        '<%= config.app %>/scripts/vendor/jquery-1.11.0.min.js',
